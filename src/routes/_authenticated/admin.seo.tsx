  ...
  const run = async () => {
    ...
    try {
      ...
      const pages: Array<{ path: string; kind: "html" | "raw" }> = [
        ...
        { path: "/?category=Solar+%26+Energy", kind: "html" },
        { path: "/?category=CCTV+%26+Security", kind: "html" },
        { path: "/?category=Edge+AI+Box", kind: "html" },
        { path: "/?category=Webcam+%26+Conference", kind: "html" },
