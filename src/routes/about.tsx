            ...
            {[
              {
                ...
                desc: "ใบเสนอราคาออกได้ทันที ใบกำกับภาษี VAT ครบ วงเงินเครดิต B2B สูงสุด ฿5,000,000 เครดิต 30-90 วัน อนุมัติภายใน 3-5 วันทำการ — สำหรับองค์กร หน่วยงานราชการ และรัฐวิสาหกิจที่ต้องมีเอกสารจัดซื้อถูกระเบียบ ไม่ใช่แค่กดซื้อแล้วจบ",
              },
              {
                icon: Sparkles,
      ...
      <section className="border-b bg-slate-50">
        <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 px-4 pt-10 md:grid-cols-4">
          {[
            ...
            { label: "วงเงินเครดิต B2B", value: "สูงสุด ฿5,000,000" },
