...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Thai:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600;700;800;900&display=swap",
      },
    ],
    scripts: [
      {
          ...
          "@graph": [
            {
              ...
              description: "ENT Group IT Shop สินค้าแท้ 100% จำหน่ายสินค้าไอทีราคา Dealer รับประกันศูนย์ไทย",
              foundingDate: "2015",
              taxID: "0135558013167",
              address: {
                "@type": "PostalAddress",
